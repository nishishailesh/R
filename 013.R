...
left=readline("left margin of interval:")
right=readline("right margin of interval:")

acidosis=data3[data3$PH1>left & data3$PH1<right & data3$PH1!=data3$PH2,]
...
ph1=hist(acidosis$PH1, breaks=seq(5,8,0.05),col=rgb(0, 0, 1, 0.5))
ph2=hist(acidosis$PH2, breaks=seq(5,8,0.05),col=rgb(0, 1, 0, 0.5),add=T)
text(6,50,paste(act$method))
text(6,45,paste("p-value=",act$p.value))
text(6,40,paste("mean difference=",
